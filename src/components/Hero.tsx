...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-hero overflow-hidden pt-16 md:pt-20">
      ...
      <div className="container relative z-10 py-6 md:py-0">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="animate-fade-up">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold leading-tight text-foreground mb-3">
            ...
            <p className="text-xs sm:text-sm font-semibold tracking-widest uppercase text-secondary mb-4 md:mb-6">
              {SITE_CONFIG.title}
            </p>
            <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold leading-snug text-foreground mb-4 md:mb-6">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-primary text-primary-foreground font-semibold text-sm sm:text-base hover:brightness-105 hover:shadow-lg transition-all"
            >
          ...
          <div className="relative animate-fade-in flex justify-center lg:justify-end">
            <div className="relative max-w-[280px] sm:max-w-sm md:max-w-md mx-auto lg:mx-0">
              <div className="absolute -inset-3 sm:-inset-4 bg-primary/20 rounded-[1.5rem] sm:rounded-[2rem] rotate-3" />
              <img
                src={heroPhoto}
                alt={SITE_CONFIG.name}
                className="relative rounded-[1.5rem] sm:rounded-[2rem] w-full object-cover shadow-2xl"
              />
            </div>
          </div>
        </div>
